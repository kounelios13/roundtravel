...
if exist "%RADS_PATH%\Game" (
	...
	if exist "League of Legends.exe" (
		@start "" "League of Legends.exe" "8394" "LoLLauncher.exe" "" "spectator spectator.euw1.lol.riotgames.com:80 ZU6xnyDjrrSqjqVosj96nF3Nzcz10w1w 4051723312 EUW1" "-UseRads" "-Locale=!locale!"
		goto :eof
	)
)
