...
import roundTravelLogo from '../../static/images/general/logo.png'
import telSvg from '../../static/images/general/phone-dial.svg'
                                            ...
                                            <Link href={'/'}>
                                                <a>
                                                    <span onMouseEnter={()=>{this.updateHoverState(true)}}
                                                          ...
                                                          className={`rt-nav-item`}>ΤΑ ΤΑΞΙΔΙΑ ΜΑΣ</span>
                                                </a>
                                            </Link>
                                            {
