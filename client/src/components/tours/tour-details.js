    ...
    return (
      <div>
        <section className='p-0 m-0 d-flex flex-wrap mb-5'>
          ...
          <div className="offset-0 col-lg-5 offset-lg-2">
            <div className="col-12 d-flex flex-wrap">
              <div className="col-12 shadow p-4 border-top-primary">
              ...
              <div className="col-12 mt-3 p-4 shadow border-top-primary">
          ...
          <div className="col-10 offset-1 mt-5 mt-lg-0 offset-lg-0 col-lg-3 p-0">
